...
public:
	...
	Button(Texture2D spritesheet, Rectangle spritesheet_source, float spritesheet_destination_x, float spritesheet_destination_y, float scale, std::string button_text);
	Button(Texture2D spritesheet, float spritesheet_source_x, float spritesheet_source_y, float spritesheet_source_width, float spritesheet_source_height, float spritesheet_destination_x, float spritesheet_destination_y, float scale, std::string button_text);
